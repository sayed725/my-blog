...
<div className="text-center mb-12">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex flex-col gap-4">
          {[
            { icon: <FaHome className="text-primary  text-2xl" />, title: "Dhaka, Bangladesh", subtitle: "Nawabjong, Dhaka 1320" },
            { icon: <FaPhoneAlt className="text-primary  text-2xl" />, title: "+8801627142598", subtitle: "Sun to Thu 9am to 8pm" },
            { icon: <FaEnvelope className="text-primary  text-2xl" />, title: "abusayedkhan.pro@gmail.com", subtitle: "Send me query anytime!" },
            { icon: <FaWhatsappSquare className="text-primary  text-2xl" />, title: "+8801627142598", subtitle: "Available 24/7!" },
          ].map((item, index) => (
